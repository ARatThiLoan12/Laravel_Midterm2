				...
				<div class="row">
					<div class="col-sm-12">
								...
								<div class="col-sm-3">
									...
									@endif
										<div class="single-item-header">
											<a href="{{route('chitietsanpham', $new->id)}}"><img src="source/image/product/{{$new->image}}" alt="" width="270" height="320"></a>
										</div>
										<div class="single-item-body">
											...
											<p class="single-item-price" style="font-size: 18px">
												...
												<span class="falsh-sale">{{$new->unit_price}}đ</span>
												@endif
											</p>
										</div>
						...
						<div class="beta-products-list">
							...
							<div class="row">
							@foreach($sanpham_khuyenmai as $product)
								<div class="col-sm-3">
									<div class="single-item">
										<div class="single-item-header">
											<a href="product.html"><img src="source/image/product/{{$product->image}}" alt="" width="270" height="320"></a>
										</div>
										<div class="single-item-body">
