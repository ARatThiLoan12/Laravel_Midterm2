		...
		<div class="container">
			...
			<div class="pull-right">
				<div class="beta-breadcrumb font-large">
					<a href="{{route('trang_chu')}}">Trang chủ</a> / <span>Chi tiết sản phẩm</span>
				</div>
			</div>
							...
							<div class="beta-sales beta-lists">
								<div class="media beta-sales-item">
									...
									<div class="media-body">
										{{$spbc->name}}
										<span class="beta-sales-price">{{$spbc->unit_price}}</span>
									</div>
								</div>
							</div>
							@endforeach
						...
						@foreach($sp_new as $spn)
							<div class="beta-sales beta-lists">
								<div class="media beta-sales-item">
									...
									<div class="media-body">
										{{$spn->name}}
										<span class="beta-sales-price">{{$spn->unit_price}}</span>
									</div>
								</div>
							</div>
						@endforeach
